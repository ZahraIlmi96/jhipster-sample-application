...
import static sn.zim.cursus.service.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
...
import sn.zim.cursus.service.config.audit.AuditEventConverter;
import sn.zim.cursus.service.domain.PersistentAuditEvent;
